...
1) It isn't easy to fecth the audio signal from the jack cable, I tried cutting and rewiring the jack cable but it resulted damaged,  so i then tried to work directly with the signal, but again it's not easy to fetch the audiosignal from the speakers via wires for the noise and for finding the means to do it. I made another cable from the previous headphones I destroyed, but it seems to not work. 
